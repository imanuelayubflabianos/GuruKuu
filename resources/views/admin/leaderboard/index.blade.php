...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Monitoring peringkat guru berdasarkan keaktifan evaluasi dari siswa.</p>
    </div>
</div>

<div class="card-custom p-3 mb-4">
    <form method="GET" action="{{ route('admin.leaderboard.index') }}" class="row g-3 align-items-end">
        <div class="col-md-3">
        ...
        <div class="col-md-3 d-flex gap-2">
            ...
            <a href="{{ route('admin.leaderboard.index') }}" class="btn btn-outline-custom btn-sm" title="Reset Filter"><i class="bi bi-arrow-counterclockwise"></i></a>
        </div>
    </form>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('landing.guru.detail', $guru->id) }}" class="btn btn-sm btn-primary-custom d-inline-flex align-items-center gap-1" target="_blank">
