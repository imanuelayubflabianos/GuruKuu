...
<div class="card-custom p-3 mb-4">
    <form method="GET" action="{{ route('admin.leaderboard.index') }}" class="row g-3 align-items-end">
        ...
        <div class="col-md-3 d-flex gap-2">
            ...
            <a href="{{ route('admin.leaderboard.index') }}" class="btn btn-outline-custom btn-sm"><i class="bi bi-arrow-counterclockwise"></i></a>
        </div>
    </form>
</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('landing.guru.detail', $guru) }}" class="btn btn-sm btn-outline-primary" target="_blank">
