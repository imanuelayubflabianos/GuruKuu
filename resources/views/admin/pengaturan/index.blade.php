...
<div class="row g-4">
    {{-- Status Periode Aktif (Hero Card) --}}
    <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        @if($periodeAktif)
                            <h3 class="fw-bold mb-1">{{ $periodeAktif->nama_periode }}</h3>
                            <small style="opacity: 0.9;">
                                <i class="bi bi-clock"></i> {{ $periodeAktif->tanggal_mulai->format('d M Y') }} s/d {{ $periodeAktif->tanggal_selesai->format('d M Y') }}
                            </small>
                        @else
                ...
                <a href="{{ route('admin.periode.index') }}" class="btn btn-light text-primary fw-bold px-4">
    ...
    {{-- Quick Links Cards --}}
    <div class="col-md-4">
        <a href="{{ route('admin.jurusan.index') }}" class="card-custom p-4 text-decoration-none h-100" style="color: inherit; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 10px 30px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='none'; this.style.boxShadow='none'">
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    ...
                    <small class="text-muted">{{ $totalJurusan }} Data Tersedia</small>
                </div>
            </div>
    ...
    <div class="col-md-4">
        <a href="{{ route('admin.badge.index') }}" class="card-custom p-4 text-decoration-none h-100" style="color: inherit; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 10px 30px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='none'; this.style.boxShadow='none'">
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    ...
                    <small class="text-muted">{{ $totalBadge }} Jenis Badge</small>
                </div>
            </div>
    ...
    <div class="col-md-4">
        <a href="{{ route('admin.periode.index') }}" class="card-custom p-4 text-decoration-none h-100" style="color: inherit; transition: all 0.3s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 10px 30px rgba(0,0,0,0.1)'" onmouseout="this.style.transform='none'; this.style.boxShadow='none'">
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    ...
                    <small class="text-muted">{{ $semuaPeriode->count() }} Total Periode</small>
                </div>
            </div>
    ...
    <div class="col-md-12">
        <div class="card-custom p-4" style="border-left: 4px solid #dc3545;">
            ...
            <div class="bg-light p-3 rounded" style="max-width: 500px;">
                <form action="{{ route('admin.pengaturan.reset') }}" method="POST" id="formReset">
                    @csrf
                    <div class="mb-3">
