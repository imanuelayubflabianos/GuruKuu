...
<section style="background: var(--bg-light); padding: 140px 0 80px; min-height: 100vh;">
    <div class="container">
        ...
        <div class="row g-2 g-md-4 mb-4 mb-md-5 align-items-end justify-content-center gk-podium-row">
            ...
            <div class="col-4 col-md-4 order-2 order-md-2 mb-0 gk-podium-col gk-podium-1" data-aos="zoom-in">
                ...
                <div class="card-custom gk-podium-card p-2.5 p-md-5 text-center position-relative" style="border: 2px solid #f59e0b; box-shadow: 0 16px 36px rgba(245, 158, 11, 0.16); background: var(--bg-card); transform: translateY(-8px);">
                    ...
                    <a href="{{ route('landing.guru.detail', $top1->id) }}" class="btn btn-primary-custom btn-podium w-100 rounded-pill py-1.5 py-md-2 fw-semibold">
                        <i class="bi bi-eye me-1"></i> Profil
                    </a>
                </div>
            </div>
        ...
        <div class="card-custom" data-aos="fade-up">
            <div class="card-header py-3 border-bottom d-flex justify-content-between align-items-center" style="background: var(--bg-card); color: var(--text-dark); border-color: var(--border) !important;">
