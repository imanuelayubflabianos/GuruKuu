...
@if($top1)
    @if(!$top2)
        {{-- HANYA 1 GURU TOP (TIDAK DEMPET, PROPORSI LEBAR & FULL CONTAINER WARNA EMAS) --}}
        @php $pct1 = round(($top1->rata_rata_nilai / 5) * 100); @endphp
        <div class="row justify-content-center mb-4 mb-md-5">
            <div class="col-12 col-sm-10 col-md-8 col-lg-6">
                <div class="card-custom gk-podium-card gk-podium-gold p-4 p-md-5 text-center position-relative shadow" style="border-radius: 20px;">
                    <div class="mb-3">
                    ...
                    <div class="p-3 rounded-3 mb-3.5 gk-podium-statbox">
                        ...
                        <small class="text-muted font-mono d-block mt-1" style="font-size: 0.78rem;">{{ $top1->total_penilaian }} {{ $mode === 'partisipasi' ? 'siswa memilih' : 'ulasan' }}</small>
                    </div>
                    <a href="{{ route('siswa.guru.show', $top1->id) }}" class="btn btn-primary-custom w-100 rounded-pill py-2.5 fw-semibold" style="font-size: 0.95rem; background: #003366;">
    ...
    @elseif(!$top3)
        {{-- HANYA 2 GURU TOP (SEIMBANG 2 KOLOM - FULL CONTAINER) --}}
        @php
        ...
        <div class="row g-3 g-md-4 justify-content-center align-items-end mb-4 mb-md-5">
            ...
            <div class="col-6 col-md-5">
                <div class="card-custom gk-podium-card gk-podium-silver p-3 p-md-4 text-center h-100 shadow-sm" style="border-radius: 16px;">
                    ...
                    <h5 class="fw-bold mb-1 text-truncate gk-podium-nama" title="{{ $top2->nama }}">{{ $top2->nama }}</h5>
                    ...
                    <div class="p-2 p-md-3 rounded-3 mb-2 mb-md-3 gk-podium-statbox">
                        ...
                        <small class="text-muted font-mono" style="font-size: 0.72rem;">{{ $top2->total_penilaian }} {{ $mode === 'partisipasi' ? 'siswa memilih' : 'ulasan' }}</small>
                    </div>
                    <a href="{{ route('siswa.guru.show', $top2->id) }}" class="btn btn-outline-custom btn-sm w-100 rounded-pill py-2">
            ...
            {{-- #1 EMAS --}}
            <div class="col-6 col-md-5">
                <div class="card-custom gk-podium-card gk-podium-gold p-3 p-md-4 text-center position-relative shadow" style="border-radius: 18px;">
                    <div class="mb-2 mb-md-3">
                    ...
                    <div class="position-relative d-inline-block mb-2 mb-md-3">
                        <img src="{{ $top1->photo_url }}" class="rounded-circle shadow gk-podium-avatar-1" width="100" height="100" style="object-fit: cover;">
                    </div>
                    <h5 class="fw-bold mb-1 text-truncate gk-podium-nama" title="{{ $top1->nama }}">{{ $top1->nama }}</h5>
                    ...
                    <div class="p-2 p-md-3 rounded-3 mb-2 mb-md-3 gk-podium-statbox">
                        ...
                        <small class="text-muted font-mono d-block mt-1" style="font-size: 0.72rem;">{{ $top1->total_penilaian }} {{ $mode === 'partisipasi' ? 'siswa memilih' : 'ulasan' }}</small>
                    </div>
                    <a href="{{ route('siswa.guru.show', $top1->id) }}" class="btn btn-primary-custom w-100 rounded-pill py-2 fw-semibold" style="background: #003366;">
                        <i class="bi bi-info-circle me-1"></i> Detail
                    </a>
                </div>
            </div>
        ...
        <div class="row g-2 g-md-4 mb-4 mb-md-5 align-items-end justify-content-center gk-podium-row">
            ...
            <div class="col-4 col-md-4 order-2 order-md-2 mb-0 gk-podium-col gk-podium-1">
                <div class="card-custom gk-podium-card gk-podium-gold p-2.5 p-md-5 text-center position-relative shadow" style="border-radius: 18px; transform: translateY(-8px);">
                    ...
                    <a href="{{ route('siswa.guru.show', $top1->id) }}" class="btn btn-primary-custom btn-podium w-100 rounded-pill py-1.5 py-md-2 fw-semibold" style="background: #003366;">
                        <i class="bi bi-info-circle me-1"></i> Detail
                    </a>
                </div>
            </div>
            ...
            <div class="col-4 col-md-4 order-3 order-md-3 gk-podium-col gk-podium-3">
                <div class="card-custom gk-podium-card gk-podium-bronze p-2 p-md-4 text-center h-100 shadow-sm" style="border-radius: 16px;">
                    <div class="mb-2 mb-md-3">
                        <span class="badge rounded-pill px-2.5 py-1 fw-bold" style="background: #c2410c; color: #fff; font-size: 0.75rem;">
                    ...
                    <div class="p-1.5 p-md-3 rounded-3 mb-2 mb-md-3 gk-podium-statbox">
                        ...
                        <div class="progress mt-1 mt-md-2 mb-1" style="height: 5px; border-radius: 10px; background: rgba(217, 119, 6, 0.2);">
                            <div class="progress-bar rounded-pill" style="width: {{ $pct3 }}%; background: #ea580c;"></div>
                        </div>
        ...
        <table class="table table-custom mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center font-mono" style="font-size: 0.75rem;">{{ strtoupper($g->jurusan?->nama_jurusan ?? 'Umum') }}</td>
                    <td>
