...
@section('content')
<div style="padding-top: 100px; padding-bottom: 60px; background: var(--bg-light); min-height: 100vh;">
    <div class="container">
                    ...
                    <div class="p-3 d-flex align-items-center gap-3" style="background: linear-gradient(135deg, var(--primary) 0%, var(--primary-light) 100%); color: white;">
                        ...
                        <div class="d-none d-md-flex gap-2">
                            <span class="badge bg-light text-dark px-3 py-2">
                                <i class="bi bi-shield-lock-fill me-1"></i> Anonim
                            </span>
                            <a href="{{ route('landing.index') }}" class="btn btn-sm btn-light">
                        ...
                        @else
                            @foreach($riwayat as $chat)
                                ...
                                <div class="d-flex justify-content-end mb-3">
                                    <div style="background: linear-gradient(135deg, var(--primary) 0%, var(--primary-light) 100%); color: white; padding: 0.85rem 1.25rem; border-radius: 18px 18px 4px 18px; max-width: 75%; box-shadow: 0 4px 12px rgba(0,51,102,0.2);">
...
<script>
    ...
    function openEditModal(id, text) {
        document.getElementById('editForm').action = '/hubungi-admin/' + id;
