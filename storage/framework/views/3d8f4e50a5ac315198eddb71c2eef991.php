...
<body>
    <aside class="sidebar">
        ...
        <a href="<?php echo e(route('admin.profil.index')); ?>" class="sidebar-profile <?php echo e(request()->routeIs('admin.profil.*') ? 'active' : ''); ?>">
        ...
        <ul class="sidebar-menu">
            <li><a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"><i class="bi bi-grid"></i> Dashboard</a></li>
            <li><a href="<?php echo e(route('admin.guru.index')); ?>" class="<?php echo e(request()->routeIs('admin.guru.*') ? 'active' : ''); ?>"><i class="bi bi-person-badge"></i> Data Guru</a></li>
            <li><a href="<?php echo e(route('admin.siswa.index')); ?>" class="<?php echo e(request()->routeIs('admin.siswa.*') ? 'active' : ''); ?>"><i class="bi bi-people"></i> Data Siswa</a></li>
            <li><a href="<?php echo e(route('admin.jurusan.index')); ?>" class="<?php echo e(request()->routeIs('admin.jurusan.*') ? 'active' : ''); ?>"><i class="bi bi-book"></i> Kategori Jurusan</a></li>
            <li><a href="<?php echo e(route('admin.kritik-saran.index')); ?>" class="<?php echo e(request()->routeIs('admin.kritik-saran.*') ? 'active' : ''); ?>"><i class="bi bi-chat-dots"></i> Feedback</a></li>
            <li><a href="<?php echo e(route('admin.kontak.index')); ?>" class="<?php echo e(request()->routeIs('admin.kontak.*') ? 'active' : ''); ?>"><i class="bi bi-envelope"></i> Pesan Masuk</a></li>
            <li><a href="<?php echo e(route('admin.leaderboard.index')); ?>" class="<?php echo e(request()->routeIs('admin.leaderboard.*') ? 'active' : ''); ?>"><i class="bi bi-trophy"></i> Leaderboard</a></li>
            <li><a href="<?php echo e(route('admin.statistik.index')); ?>" class="<?php echo e(request()->routeIs('admin.statistik.*') ? 'active' : ''); ?>"><i class="bi bi-bar-chart"></i> Laporan</a></li>
            <li><a href="<?php echo e(route('admin.pengaturan.index')); ?>" class="<?php echo e(request()->routeIs('admin.pengaturan.*') ? 'active' : ''); ?>"><i class="bi bi-gear"></i> Pengaturan</a></li>
        </ul>
