...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - GuruKuu Guru</title>
...
<body>
    <aside class="sidebar">
        <a href="<?php echo e(route('guru.dashboard')); ?>" class="sidebar-brand">GuruKuu</a>
        ...
        <div class="sidebar-profile">
            ...
            <div>
                ...
                <div class="sidebar-profile-role">NIP: <?php echo e(auth()->user()->nis); ?></div>
            </div>
        </div>

        <ul class="sidebar-menu">
            <li><a href="<?php echo e(route('guru.dashboard')); ?>" class="<?php echo e(request()->routeIs('guru.dashboard') ? 'active' : ''); ?>"><i class="bi bi-grid"></i> Dashboard</a></li>
            <li><a href="<?php echo e(route('landing.leaderboard')); ?>" target="_blank"><i class="bi bi-trophy"></i> Leaderboard Publik</a></li>
            <li><a href="<?php echo e(route('auth.ganti-password')); ?>"><i class="bi bi-key"></i> Ganti Password</a></li>
        </ul>
...
<?php /**PATH C:\Users\ADVAN\PROJEK\Laravel\GuruKuu\resources\views/layouts/guru.blade.php ENDPATH**/ ?>