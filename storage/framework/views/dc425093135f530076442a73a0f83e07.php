    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8" data-aos="fade-right">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn btn-cta">Siap Memulai?</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4">
            <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="100">
                <div class="stat-card-modern" style="border-left: 4px solid var(--primary);">
                    ...
                    <div class="stat-number"><?php echo e($totalGuru ?? 0); ?></div>
            ...
            <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="200">
                <div class="stat-card-modern" style="border-left: 4px solid var(--accent);">
                    ...
                    <div class="stat-number"><?php echo e($totalSiswa ?? 0); ?></div>
            ...
            <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="300">
                <div class="stat-card-modern" style="border-left: 4px solid var(--secondary);">
                    ...
                    <div class="stat-number"><?php echo e($totalPenilaian ?? 0); ?></div>
            ...
            <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="400">
                <div class="stat-card-modern" style="border-left: 4px solid #6366f1;">
                    ...
                    <?php if(isset($periodeAktif) && $periodeAktif): ?>
                        <div class="stat-number" style="font-size: 1.5rem; line-height: 1.3;">
                            <?php echo e($periodeAktif->semester === 'ganjil' ? 'Ganjil' : 'Genap'); ?>

                            <div style="font-size: 1rem; font-weight: 600; margin-top: 0.25rem;"><?php echo e($periodeAktif->tahun_ajaran); ?></div>
                        </div>
                    <?php else: ?>
...
<section id="guru" class="section-padding" style="background: var(--bg-light);">
    <div class="container">
        ...
        <div class="tab-content">
            ...
            <?php $__currentLoopData = ['normada' => $topNormada, 'produktif' => $topProduktif]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($list->count() > 0): ?>
                        ...
                        <div class="col-md-3 order-md-1" data-aos="fade-right">
                            <div class="card-custom p-4 text-center" style="border: 1px solid var(--border);">
                                <div class="position-relative d-inline-block mb-3">
                                    <img src="<?php echo e($list[1]->photo_url); ?>" class="rounded-circle" width="80" height="80" style="object-fit: cover; border: 3px solid #C0C0C0;">
                                ...
                                <h6 class="fw-bold mb-1"><?php echo e($list[1]->nama); ?></h6>
                                <div class="mb-2">
                                    <div class="fw-bold" style="color: var(--primary); font-size: 1.3rem;"><?php echo e(number_format($list[1]->persentase, 0)); ?>%</div>
                                    <small class="text-muted"><?php echo e($list[1]->total_penilaian); ?> siswa menilai</small>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="col-md-4 order-md-2 mt-md-4" data-aos="zoom-in">
                            <div class="card-custom p-5 text-center" style="background: var(--primary); border: none; color: white;">
                                <div class="position-relative d-inline-block mb-3">
                                    <img src="<?php echo e($list[0]->photo_url); ?>" class="rounded-circle" width="110" height="110" style="object-fit: cover; border: 4px solid var(--secondary);">
                                ...
                                <h5 class="fw-bold mb-1"><?php echo e($list[0]->nama); ?></h5>
                                <div class="font-mono mb-2" style="font-size: 0.7rem; letter-spacing: 1px; color: rgba(255,255,255,0.7);"><?php echo e(strtoupper($list[0]->jurusan?->nama_jurusan ?? 'UMUM')); ?></div>
                                <div class="mb-2">
                                    <div class="fw-bold" style="color: var(--secondary); font-size: 2rem;"><?php echo e(number_format($list[0]->persentase, 0)); ?>%</div>
                                    <small style="opacity: 0.8;"><?php echo e($list[0]->total_penilaian); ?> siswa menilai</small>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="col-md-3 order-md-3" data-aos="fade-left">
                            <div class="card-custom p-4 text-center" style="border: 1px solid var(--border);">
                                <div class="position-relative d-inline-block mb-3">
                                    <img src="<?php echo e($list[2]->photo_url); ?>" class="rounded-circle" width="80" height="80" style="object-fit: cover; border: 3px solid #CD7F32;">
                                ...
                                <h6 class="fw-bold mb-1"><?php echo e($list[2]->nama); ?></h6>
                                <div class="mb-2">
                                    <div class="fw-bold" style="color: var(--primary); font-size: 1.3rem;"><?php echo e(number_format($list[2]->persentase, 0)); ?>%</div>
                                    <small class="text-muted"><?php echo e($list[2]->total_penilaian); ?> siswa menilai</small>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
        ...
        <div class="text-center" data-aos="zoom-in">
            <a href="<?php echo e(route('login')); ?>" class="btn btn-cta"><i class="bi bi-box-arrow-in-right"></i> Login untuk Lihat Lengkap & Beri Penilaian</a>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ADVAN\PROJEK\Laravel\GuruKuu\resources\views/landing/index.blade.php ENDPATH**/ ?>